...
Fixpoint is open-source infra for stateful AI workflows with human-in-the-loop.
We let you build long-running AI workflows that you can transition between
chatbot, autonomous agents, and human-in-the-loop review.
